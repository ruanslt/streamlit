...
st.subheader('Este é um subheader: _Stremlit_')
...
st.markdown("""
            :red[Streamlit] :orange[pode] :green[escrever] :blue[texto] :violete[em] :gray[muitas] :rainbow[cores] e :blue-background[texto destacado]
...
with aba2:
    ...
    #cria um array de 20 linhas  x 3 colunas, com valores randomcos (distribuição padrão)
...
with aba3:
    ...
    #cria uma distribuição normal aleatoria de tamnho 100com média dde 1 e desvio padrao de 1
